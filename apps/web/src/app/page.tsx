...
const jsonLd = {
  ...
  "@graph": [
    {
      "@type": "Organization",
      "@id": "https://useownlane.com/#organization",
      name: "Ownlane",
    ...
    {
      "@type": "WebSite",
      "@id": "https://useownlane.com/#website",
      url: "https://useownlane.com",
      name: "Ownlane",
      publisher: { "@id": "https://useownlane.com/#organization" },
    },
  ],
};
    ...
    <main className="bg-white text-black">
      ...
      <section id="top" className="mx-auto max-w-[1440px] border-t border-black">
        <div className="flex min-h-[640px] flex-col items-center justify-between px-5 py-7 text-center sm:px-8 lg:px-12">
          <p className="reveal text-xs font-bold uppercase tracking-[0.15em] text-[#ff4d00]">THE CREATOR BUSINESS HOME</p>
          <div className="flex flex-col items-center py-16"><h1 className="reveal reveal-delay-1 max-w-5xl text-[clamp(4.4rem,10vw,9.4rem)] font-black leading-[0.78] tracking-[-0.1em]">THE HOME FOR<br />WHAT YOU <span className="text-[#ff4d00]">MAKE.</span></h1><p className="reveal reveal-delay-2 mt-10 max-w-xl text-lg leading-7 text-black/65 sm:text-xl">One branded place to sell products, take bookings, accept support, run memberships, and know the people behind your business.</p><a className="button-pour reveal reveal-delay-3 mt-8 inline-flex bg-black px-5 py-4 text-sm font-bold uppercase tracking-[0.09em] text-white [--button-fill:#ff4d00]" href="#early-access"><span>Be part of the first wave</span></a></div>
          <div className="flex w-full self-stretch items-end justify-between border-t border-black pt-4"><p className="font-mono text-[10px] uppercase tracking-[0.16em] text-black/45">One link. Every way to move.</p><p className="hidden max-w-xs text-right text-xs font-bold uppercase tracking-[0.12em] text-black/65 sm:block">For creators who are done stitching their business together.</p></div>
        </div>
      </section>
